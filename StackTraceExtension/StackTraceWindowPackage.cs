//------------------------------------------------------------------------------
// <copyright file="StackTraceWindowPackage.cs" company="Company">
...
namespace StackTraceExtension
{
    ...
    {
        /// <summary>
        /// StackTraceWindowPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "2a0237f4-10ef-4ddd-8d2f-9a11caf653b3";

        /// <summary>
        /// Initializes a new instance of the <see cref="StackTraceWindow"/> class.
        /// </summary>
        public StackTraceWindowPackage()
        {
        ...
        {
            StackTraceWindowCommand.Initialize(this);
            base.Initialize();
        }
