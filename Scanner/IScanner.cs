...
namespace Scanner
{
    ...
    public interface IScanner
    {
        ...
        IMultiFileScanResult Scan(IEnumerable<string> filePaths, string searchingWord);
        ...
        /// <returns>The result of the scan.</returns>
        /// <exception cref="System.ArgumentNullException">Thrown if <c>filePaths</c> or <c>termTables</c> is null.</exception>
        IMultiFileScanResult Scan(IEnumerable<string> filePaths, string searchingWord, FileScanCompleted callback);
        ...
        /// <returns>The result of the scan.</returns>
        /// <exception cref="System.ArgumentNullException">Thrown if <c>filePaths</c> or <c>termTables</c> is null.</exception>
        IMultiFileScanResult Scan(IEnumerable<string> filePaths, string searchingWord, FileScanCompleted callback, FileContentGetter contentGetter);
        ...
        /// <returns>The result of the scan.</returns>
        /// <exception cref="System.ArgumentNullException">Thrown if <c>filePaths</c> or <c>termTables</c> is null.</exception>
        IMultiFileScanResult Scan(IEnumerable<string> filePaths, string searchingWord, FileScanCompleted callback, FileContentGetter contentGetter, ScanStopper stopper);
    }
}
