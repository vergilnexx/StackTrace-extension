...
namespace Scanner
{
    class Scanner : IScanner
    {
        ...
        /// </summary>
        public IMultiFileScanResult Scan(IEnumerable<string> filePaths, string searchingWord)
        {
            return Scan(filePaths, searchingWord, null);
        }

        /// <summary>
        /// See <c>IScanner</c> documentation.
        /// </summary>
        public IMultiFileScanResult Scan(IEnumerable<string> filePaths, string searchingWord, FileScanCompleted callback)
        {
            return Scan(filePaths, searchingWord, callback, null);
        }
